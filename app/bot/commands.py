...
async def setup_bot_commands(bot: Bot) -> None:
    ...
    commands = [
        ...
        BotCommand(command="queue_status", description="Пульт очереди"),
        BotCommand(command="queue_failed", description="Failed-задачи"),
        BotCommand(command="queue_retry_failed", description="Retry failed"),
        BotCommand(command="queue_cleanup_done", description="Очистить done"),
