...
class LLMService:
    ...
    async def complete(
        ...
        try:
            return await self._request_text(messages=messages, max_tokens=1800, temperature=0.4)
        except Exception:
    ...
    async def generate_document_data(
        ...
        """
        Генерирует структурированные данные для DOCX/PDF.
        ...
        Если LLM не подключён или ответ некорректный — возвращает fallback-структуру.
        """
